package com.rmit.design_patterns.commandpattern;
...
class ChangFenChef extends JFrame
{
    ...
    {
        super("煮肠粉");
        l.setIcon(new ImageIcon("./assets/changfen.jpeg"));
        this.add(l);
...
class HunTunChef extends JFrame
{
    ...
    {
        super("煮馄饨");
        l.setIcon(new ImageIcon("./assets/hundun.jpeg"));
        this.add(l);
...
class HeFenChef extends JFrame
{
    ...
    {
        super("煮河粉");
        l.setIcon(new ImageIcon("./assets/hefen.jpeg"));
        this.add(l);
